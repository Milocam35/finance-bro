...
interface EducationFiltersProps {
  onFilterChange: (filters: EducationFilterState) => void;
}

export type EducationType = "all" | "pregrado" | "posgrado";
...
const DEFAULT_FILTERS: EducationFilterState = {
  amount: 20000000,
  term: 1,
  sortBy: "rate",
  educationType: "all",
...
export function EducationFilters({ onFilterChange }: EducationFiltersProps) {
  ...
  const handleReset = () => {
    ...
    setAmountInput("20000000");
    setTermInput("1");
    onFilterChange(DEFAULT_FILTERS);
  };

  const isFiltersModified =
    filters.amount !== 20000000 ||
    filters.term !== 1 ||
    filters.sortBy !== "rate" ||
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Filtra entre las opciones de crédito educativo
              </p>
            </div>
          </div>
          {isFiltersModified && (
