          ...
          <div className="p-5 h-[calc(100%-4px)] flex flex-col">
            ...
            <div className="flex gap-1.5 mb-4 flex-wrap">
              ...
              {producto.denominacion && (
                <span className="text-[10px] font-medium px-2.5 py-1 rounded-full border bg-violet-50 text-violet-700 border-violet-200 dark:bg-violet-950 dark:text-violet-300 dark:border-violet-800">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground">Detalles del crédito educativo</p>
                </div>
              </div>
              <button
