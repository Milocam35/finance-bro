...
import {
  ...
  RotateCcw, ArrowRight, Clock, Wallet, TrendingDown, CalendarDays,
} from "lucide-react";
...
const BANK_LOGOS: Record<string, string> = {
  ...
  icetex: "/images/banks/icetex.png",
  fincomercio: "/images/banks/fincomercio.png",
  "banco de bogota": "/images/banks/bancodebogota.png",
  "banco de bogotá": "/images/banks/bancodebogota.png",
  "banco pichincha": "/images/banks/pichincha.png",
  pichincha: "/images/banks/pichincha.png",
  "banco de occidente": "/images/banks/bancodeoccidente.png",
  occidente: "/images/banks/bancodeoccidente.png",
  "banco popular": "/images/banks/bancopopular.png",
  popular: "/images/banks/bancopopular.png",
  "banco caja social": "/images/banks/cajasocial.png",
  "caja social": "/images/banks/cajasocial.png",
  cotrafa: "/images/banks/cotrafa.png",
  falabella: "/images/banks/falabella.png",
  "banco falabella": "/images/banks/falabella.png",
  cfa: "/images/banks/cfa.png",
};
...
const BANK_COLORS: Record<string, { primary: string; bg: string }> = {
  ...
  occidente: { primary: "#0066CC", bg: "rgba(0,102,204,0.08)" },
  ...
  cfa: { primary: "#C8102E", bg: "rgba(200,16,46,0.08)" },
};
...
export function InversionCard({ producto, index, loanAmount: _loanAmount }: InversionCardProps) {
        ...
        <div className="absolute inset-0 rounded-2xl border border-border bg-card overflow-hidden" style={{ backfaceVisibility: "hidden" }}>
          ...
          <div className="p-5 h-[calc(100%-4px)] flex flex-col">
            ...
            <div className="flex items-start gap-3.5 mb-5">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0 border border-border/50 overflow-hidden" style={{ backgroundColor: bankColor.bg }}>
                {logo ? (
              ...
              {(producto.monto?.monto_maximo ?? 0) > 0 && (
                <div className="flex items-center gap-2 p-2 rounded-lg bg-muted/40">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] font-semibold text-foreground truncate">{formatCurrency(producto.monto!.monto_maximo!)}</p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-1.5 mb-3 flex-1">
                {producto.beneficios!.slice(0, 2).map((b, i) => (
                  <div key={i} className="flex items-start gap-1.5">
                    ...
                    <span className="text-[10px] text-muted-foreground leading-tight line-clamp-1">{b.descripcion}</span>
                  </div>
                ))}
                {producto.beneficios!.length > 2 && <p className="text-[9px] text-muted-foreground/60 pl-[18px]">+{producto.beneficios!.length - 2} beneficios más</p>}
              </div>
            )}
            ...
            <div className="flex gap-2.5 mt-auto">
              <button onClick={() => setIsFlipped(true)}
                ...
                Más info <ArrowRight className="w-3.5 h-3.5" />
              </button>
              <button
                ...
                style={{ backgroundColor: bankColor.primary, boxShadow: `0 4px 14px ${bankColor.primary}40` }}
