          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Filtra entre las opciones de libre inversión
              </p>
            </div>
          </div>
          {isFiltersModified && (
              ...
              <label className="flex items-center gap-2 text-sm font-medium text-foreground">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p className="text-sm">
                      Valor aproximado del crédito de libre inversión que necesitas.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </label>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm font-medium text-foreground">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p className="text-sm">
                      Tiempo en años en que planeas pagar el crédito de libre inversión.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </label>
